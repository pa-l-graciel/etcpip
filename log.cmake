...
#if you are building in - source,                                              \
    this is the same as CMAKE_CURRENT_SOURCE_DIR, otherwise this
...
#this is the directory, from which cmake was started,                          \
    i.e.the top level source directory
MESSAGE(STATUS "CMAKE_SOURCE_DIR:         " $ {
  CMAKE_SOURCE_DIR
})

#this is the directory where the currently processed CMakeLists                \
    .txt is located in
...
#this is the filename including the complete path of the file                  \
...
#the complete system name, e.g."Linux-2.4.22",                                 \
...
MESSAGE(STATUS "MSVC_IDE: " $ {
  MSVC_IDE
})
MESSAGE(STATUS "MSVC60: " $ {
  MSVC60
})
MESSAGE(STATUS "MSVC70: " $ {
  MSVC70
})
MESSAGE(STATUS "MSVC71: " $ {
  MSVC71
})
MESSAGE(STATUS "MSVC80: " $ {
  MSVC80
})
MESSAGE(STATUS "CMAKE_COMPILER_2005: " $ {
  CMAKE_COMPILER_2005
})

#set this to true if you don
#but not the actual source files or headers(                                   \
...
#this will cause CMake to not put in the rules that re -                       \
    run CMake.This might be useful if
...
MESSAGE(STATUS "CMAKE_BUILD_TYPE: " $ {
  CMAKE_BUILD_TYPE
    ...
    then all libraries are built as shared libraries by default.
